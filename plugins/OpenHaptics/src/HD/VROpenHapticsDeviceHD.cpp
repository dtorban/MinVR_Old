...
#include "VROpenHapticsDeviceHD.h"
#include <api/VRButtonEvent.h>
#include <api/VRCursorEvent.h>

namespace MinVR {

VROpenHapticsDeviceHD::VROpenHapticsDeviceHD(const std::string& name) : name(name) {
    #ifdef WITH_HAPTICS
...
VROpenHapticsDeviceHD::~VROpenHapticsDeviceHD() {
#ifdef WITH_HAPTICS
    hdStopScheduler();
...
void VROpenHapticsDeviceHD::appendNewInputEventsSinceLastCall(VRDataQueue* queue) {
#ifdef WITH_HAPTICS
...
void VROpenHapticsDeviceHD::beginUpdate() {
#ifdef WITH_HAPTICS
...
void VROpenHapticsDeviceHD::endUpdate() {
#ifdef WITH_HAPTICS
...
void VROpenHapticsDeviceHD::handleEvent(EventType type) {
#ifdef WITH_HAPTICS
...
void VROpenHapticsDeviceHD::getDeviceState() {
#ifdef WITH_HAPTICS
    hdMakeCurrentDevice(hHD);
...
HDCallbackCode HDCALLBACK VROpenHapticsDeviceHD::getDeviceState(void *data) {
    VROpenHapticsDeviceHD* device = static_cast<VROpenHapticsDeviceHD*>(data);
